...
mod tests {
    ...
    fn builds_grouped_counts() {
        ...
        let now = Instant::now();
        stats.record("zs/v1/h-a/telemetry/x/m1", 4, None, now, None, None);
        stats.record("zs/v1/h-a/telemetry/x/m1", 4, None, now, None, None);
        stats.record("zs/v1/h-a/telemetry/x/m2", 4, None, now, None, None);
        stats.record("zs/v1/h-b/state/x/health", 4, None, now, None, None);
    ...
    fn collapsed_nodes_aggregate_their_subtree() {
        ...
        stats.record("zs/v1/h-a/telemetry/x/m1", 4, None, now, None, None);
        stats.record("zs/v1/h-a/telemetry/x/m1", 4, None, now, None, None);
        stats.record("zs/v1/h-a/telemetry/x/m2", 10, None, now, None, None);
        stats.record("zs/v1/h-b/state/x/health", 7, None, now, None, None);
