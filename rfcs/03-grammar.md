...
| `@blob` | queryables | bulk/content-addressed transfer; pull-only (the experimental one-to-many `fanout` publication moved to [07-bulk-planes.md Appendix A](07-bulk-planes.md) in v1.17) |
